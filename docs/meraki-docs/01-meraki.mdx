...
It should take you to a login page for the Meraki Dashboard. Please sign in using the credentials provided to you. If asked for an Organizaiotn to log into. Please choose the `CiscoLive` organization.
...
![profile](../../static/img/meraki/select-profile.png)
...
![api key](../../static/img/meraki/generate-api-key.png)
...
![org id](../../static/img/meraki/ord-id.png)
