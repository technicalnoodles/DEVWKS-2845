...
While in the **Configuration** section, we need to update the **General configuration** tab. Click on the **General conifguration** tab and then click on **Edit** on the right side. Scroll down to the **Timeout** field and change it to `60` seconds. It will look like the below image:
