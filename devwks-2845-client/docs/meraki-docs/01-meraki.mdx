...
If you click on `Systems Manager` then `General` and scroll to the bottom, in the `SecureX` section, you should see the ***Network ID*** Make a copy of this.

***Alternatively*** if you are doing this in the future, you can get the Network ID a different way using the Meraki Dashboard API
